...
from models.layers import (
    Multi_Level_Feature_Aggregation, CBA1x1, CBA3x3, ResBlock, ECA,
    Change_Specific_Transfer, task_interaction_module, decoder, Boundary_Decoder,
)
...
class BTSCD(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        out2 = F.interpolate(out2, x_size[2:], mode='bilinear', align_corners=True)
        change_out = F.interpolate(new_change, x_size[2:], mode='bilinear', align_corners=True)
